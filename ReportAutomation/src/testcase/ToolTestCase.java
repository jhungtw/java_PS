...
public class ToolTestCase {
    ...
    Tool.sendEmailByTWMSmtp("jhung@totalwine.com", "jhung@totalwine.com,jerry110160@gmail.com", "jhung@totalwine.com,jerry110160@gmail.com", "XXX", "c:\\tmp\\testyaml");
}
	...
	public void testCopyFiles() throws ZipException {
		try {
			Tool.copyFiles("ftp", "ftp.totalwine.com", "jhung", "Hhj050460@", "c:\\tmp\\QtyDiff.zip", "QtyDiff.zip", "/jerrytmp/");
		} catch (Exception e) {
